...
function App() {
  ...
  const [userName, setUserName] = useState("Rishabh pandey")    // // // User Name here.
  const [userImage, setUserImage] = useState("https://res.cloudinary.com/fipzdcdt/image/upload/f_auto,q_auto/rishabhp.png_wffdwk")    // // // User Name here.
